  ...
  return <div className="min-h-screen bg-logaz-background pb-16">
      ...
      <main className="p-4">
        <div className="h-[400px] bg-gray-100 rounded-lg overflow-hidden relative mb-4">
          <YandexMap onStationClick={() => {}} routePoints={routePoints} selectedRouteId={selectedRoute} />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <div className="relative">
                  <Input id="start-point" value={startPoint} onChange={e => setStartPoint(e.target.value)} placeholder="Введите точку отправления" className="pl-10" />
              ...
              <div>
                ...
                <div className="relative">
                  <Input id="end-point" value={endPoint} onChange={e => setEndPoint(e.target.value)} placeholder="Введите пункт назначения" className="pl-10" />
                  <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} />
                </div>
              </div>
            </div>
          ...
          <Button className="w-full bg-logaz-blue hover:bg-logaz-blue/90" onClick={handleCalculateRoute}>
        ...
        {routeCalculated && <>
            ...
            <div className="space-y-3">
              {routeOptions.map((route, index) => <div key={route.id} className="bg-white rounded-lg shadow-md p-4">
