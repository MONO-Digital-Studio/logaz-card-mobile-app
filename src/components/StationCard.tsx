...
const StationCard: React.FC<StationCardProps> = ({ station, onRouteClick, onDetailsClick }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4 mb-3 animate-fade-in">
      <div className="flex justify-between items-start">
        ...
        {station.distance && (
          <div className="bg-logaz-blue/10 px-3 py-1 rounded-full text-sm text-logaz-blue font-medium">
            {station.distance}
          </div>
        )}
      </div>
      ...
      <div className="flex justify-between mt-4">
        ...
        <Button 
          className="flex-1 bg-logaz-blue hover:bg-logaz-blue/90"
